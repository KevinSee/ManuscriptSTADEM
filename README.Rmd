...
> See, K.E., R.N. Kinzer, M.W. Ackerman and K. Lawry (2020). _`r Title`_. Name of journal/book <https://doi.org/xxx/xxx>

Our pre-print is online here:

> See, K.E., R.N. Kinzer, M.W. Ackerman and K. Lawry (2020). _`r Title`_. Name of journal/book, Accessed `r format(Sys.Date(), "%d %b %Y")`. Online at <https://doi.org/xxx/xxx>
...
> See, K.E., R.N. Kinzer, M.W. Ackerman and K. Lawry (`r format(Sys.Date(), "%Y")`). _Compendium of R code and data for `r Title`_. Accessed `r format(Sys.Date(), "%d %b %Y")`. Online at <https://doi.org/xxx/xxx>
