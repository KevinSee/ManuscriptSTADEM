...
\end{aligned}
$$
In practice, the total number of fish crossing LGR each week, $X_t$, could be split into other discrete groups if desired; for example, individual wild stocks using genetic stock identification or hatchery stocks with parentage based tagging [@Steele2019].
